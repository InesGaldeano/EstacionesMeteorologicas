...
```{r}
est1 <- descargar_leer_estaciones("NH0472", "../estacionNH0472.csv") est2 <- descargar_leer_estaciones("NH0910", "../estacionNH0910.csv")
```

**Combinar y resumir**

```{r}
todas <- dplyr::bind_rows(est1, est2) tabla_resumen_temperatura(todas)
```
