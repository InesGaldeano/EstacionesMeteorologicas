---
title: "Estaciones Meteorólogicas"
...
Si no se indican suficientes colores para todas las estaciones, la función asigna colores aleatorios automáticamente.
...
Unir los datos en un solo tibble
```{r}
todas_estaciones <- dplyr::bind_rows(est1, est2, est3)
```
