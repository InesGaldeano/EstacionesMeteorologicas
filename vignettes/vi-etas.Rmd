...
vignette: >
  %\VignetteIndexEntry{EstacionesMeteorologicas}
...
El paquete EstacionesMeteorologicas permite descargar, leer, procesar y visualizar datos meteorológicos provenientes del repositorio educativo del proyecto rse-r/intro-programacion.
...
La función descargar_leer_estaciones() obtiene los datos crudos correspondientes a una estación identificada por su código (por ejemplo "NH0472").
...
El paquete EstacionesMeteorologicas proporciona un flujo de trabajo completo para:
